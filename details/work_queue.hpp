...
namespace lyc {
// Use the internal lock-free implementation of reference counting for memory
// management instead of shared_ptr, because shared_ptr is likely to be
// implemented internally with locks, and our goal is a lock-free data structure
template <typename T>
class lock_free_queue {
 ...
 public:
  void push(T value) {
    std::unique_ptr<T> new_data(std::make_unique<T>(std::move(value)));
